...
[`@aws-sdk/client-database-migration-service`](https://www.npmjs.com/package/@aws-sdk/client-database-migration-service/v/3.1121.0).
...
- @aws-sdk/client-database-migration-service - [https://cloud-sdk-builds.github.io/?sdk=client-database-migration-service](https://cloud-sdk-builds.github.io/?sdk=client-database-migration-service)
- @aws-sdk/client-database-migration-service v3.1121.0 - [https://cloud-sdk-builds.github.io/?sdk=client-database-migration-service&version=3.1121.0](https://cloud-sdk-builds.github.io/?sdk=client-database-migration-service&version=3.1121.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-database-migration-service@3.1121.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nqiIsNe/j3x/5HBTTgoY7ck+LeHGJL8P9CQ1eLlyc23kI6M7zmnIyRRh1woUJc7p
```
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-database-migration-service/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-database-migration-service": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-database-migration-service@3.1121.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-database-migration-service@3.1121.0/index.min.mjs": "sha384-nqiIsNe/j3x/5HBTTgoY7ck+LeHGJL8P9CQ1eLlyc23kI6M7zmnIyRRh1woUJc7p"
        }
      }
</script>
```
...
<html lang="en">
      ...
      <body>
            <h1>Hello World!</h1>
            <script type="module">
                  import {  } from "@aws-sdk/client-database-migration-service";
...
```
https://github.com/cloud-sdk-builds/client-database-migration-service/blob/refs/tags/3.1121.0/LICENSE
```
